...
{
    private static final String TAG = "SqliteResultRow";
    ...
    */
    ...
    public byte[] getBlob(int columnIndex) {
        ...
        {
            log.error(TAG, "BlobStream error", e);
        }
     ...
     * @param functionSpec FunctionSpec indicating type of operation and related parameters
    ...
    protected static Object sqlFunction(FunctionSpec functionSpec, DatabaseResults results) 
    {
        try
        {
            ...
            {
            case getColumnIndex: return Integer.valueOf(results.findColumn(functionSpec.getColumnName()));
            case getColumnNames: return results.getColumnNames();
            case getColumnCount: return Integer.valueOf(results.getColumnCount());
            case getBlob: return results.getBlobStream(functionSpec.getColumnIndex());
            case getString: return results.getString(functionSpec.getColumnIndex());
            case getShort: return Short.valueOf(results.getShort(functionSpec.getColumnIndex()));
            case getInt: return Integer.valueOf(results.getInt(functionSpec.getColumnIndex()));
            case getLong: return Long.valueOf(results.getLong(functionSpec.getColumnIndex()));
            case getFloat: return results.getFloat(functionSpec.getColumnIndex());
            case getDouble: return results.getDouble(functionSpec.getColumnIndex());
            case isNull: return Boolean.valueOf(results.wasNull(functionSpec.getColumnIndex()));
            default:
